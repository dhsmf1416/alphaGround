...
public class PlayerAgent : Agent
{
        ...
        if (alive)
        {
            ...
            if (currentHealth <= 0 && alive)
            {
                ...
                if (gameObject.GetComponent<player>() != null)
                {
                    ...
                    myPlayer.aliveUI.SetActive(false);
                    myPlayer.gameover.SetActive(true);
                    myPlayer.rank.GetComponent<Text>().text += mapM.alivepeop.text;
                    for(int i=0; i<mapM.playerlist.Length;i++)
                    {
                        Destroy(mapM.playerlist[i]);
                    }
    ...
    public void shoot(float hori, float vert)
    {
        ...
        Vector2 tempvelocity = lookPoint.normalized * 60;
    ...
    public void MoveAgent(float[] act)
    {
        ...
        else
        {
            ...
            moveVelocity = moveInput.normalized * 15f;
